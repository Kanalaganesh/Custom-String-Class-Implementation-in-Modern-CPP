...
int main()		
{
String s,s1,s2,s3("Vector"),s4(s3);
char ch,*p;
int op,n,i,a,op1;
bool r;
...
cout<<"1)strcpy 2)strncpy  3)strcmp  4)strncmp  5)strcat  6)strncat  7)strrev  8)strupper  9)strlower  10)strchr  11)strrchr  12)strstr  13)strlen 14)check_boolean_operatons 15)subcript_oveloaded 16)assignment_oveloaded 17)exit"<<endl;
cin>>op;
...
case 14:cout<<"enter your choice"<<endl;
        cout<<"1) > greterthan 2) < lessthan 3) >= greterthan_equal 4) <= lessthan_equal  5) == equal 6) != notequal"<<endl;
	cin>>op1;
	switch(op1)
	{
          case 1:cout<<"enter string1 and string 2\n";
          cin>>s1>>s2;
	  r=s1>s2;
	  cout<<boolalpha<<r<<endl;
	  break;

          case 2:cout<<"enter string1 and string 2\n";
          cin>>s1>>s2;
	  r=s1<s2;
	  cout<<boolalpha<<r<<endl;
	  break;
...
case 15:cout<<"enter a string"<<endl;
        cin>>s;
